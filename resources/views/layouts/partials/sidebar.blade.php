...
<ul class="p-5 text-white font-semibold">
    ...
    <a href="{{ route('paket.index')}}">
        <li class="py-1">
            <div class="@if(Request::routeIs('paket.index')) bg-white text-[#5AB2FF] @endif flex items-center px-4 py-2 transition-color duration-300 hover:bg-white hover:text-[#5AB2FF] rounded-xl">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 mr-2">
