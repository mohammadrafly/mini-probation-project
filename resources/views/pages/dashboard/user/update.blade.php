...
<div class="container mx-auto px-4 py-8">
    <form action="{{ route('user.update', $user->id) }}" method="POST" class="w-full mx-auto">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nip" id="nip" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ $user->nip }}" required>
        </div>
        <div class="mb-4">
